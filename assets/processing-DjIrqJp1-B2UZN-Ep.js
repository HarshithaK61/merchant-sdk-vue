...
`,e=document.createElement("div");return e.innerHTML=a,e.querySelector("#close-btn")?.addEventListener("click",async()=>{if(console.log("Close clicked"),s==="success"){const{dispatchConcordiumEvent:i}=await c(async()=>{const{dispatchConcordiumEvent:r}=await import("./concordium-modal-logo-DS-Kh-HG-CfCNeDhs.js").then(n=>n.m);return{dispatchConcordiumEvent:r}},__vite__mapDeps([0,1,2]));i({type:"close",source:"desktop",modalType:"processing",data:{state:"success",action:"close"}})}g()}),e.firstElementChild},V=async()=>{const{getGlobalContainer:s}=await c(async()=>{const{getGlobalContainer:o}=await import("./concordium-modal-logo-DS-Kh-HG-CfCNeDhs.js").then(d=>d.m);return{getGlobalContainer:o}},__vite__mapDeps([0,1,2])),a=s();if(!a){console.error("Container not found for processing modal");return}const e=a.querySelector(".desktop--modal-overlay");t=p("loading"),t.id="processing-modal";const i=t.querySelector(".desktop--modal-container");t.style.opacity="0",i.style.transform="translateY(-20px) scale(0.95)",i.style.transition="transform 0.3s ease-out",a.appendChild(t),t.offsetHeight,t.style.transition="opacity 0.3s ease-out",setTimeout(()=>{if(e){const o=e.querySelector(".desktop--modal-container");e.style.transition="opacity 0.3s ease-in",o&&(o.style.transition="transform 0.3s ease-in",o.style.transform="translateY(-20px) scale(0.95)"),e.style.opacity="0",e.style.pointerEvents="none",e.style.zIndex="9998"}t.style.opacity="1",i.style.transform="translateY(0) scale(1)",e&&setTimeout(()=>{e.parentNode&&e.parentNode.removeChild(e)},350)},10),e&&setTimeout(()=>{e.parentNode&&e.parentNode.removeChild(e)},300);const{dispatchConcordiumEvent:r}=await c(async()=>{const{dispatchConcordiumEvent:o}=await import("./concordium-modal-logo-DS-Kh-HG-CfCNeDhs.js").then(d=>d.m);return{dispatchConcordiumEvent:o}},__vite__mapDeps([0,1,2]));r({type:"processing",source:"desktop",modalType:"processing",data:{state:"loading",message:"Verification in progress"}});const n=async o=>{console.log("Verification completed event received:",o.detail),await h()};window.addEventListener("concordium-event",o=>{o.detail?.type==="verification-completed"&&n(o)}),l=()=>{window.removeEventListener("concordium-event",n)}},g=()=>{t&&(t.classList.add("modal-exiting"),setTimeout(()=>{const s=t?.parentNode;s&&t&&s.removeChild(t),t=null},300)),l&&(l(),l=null)};async function h(){const{getGlobalContainer:s}=await c(async()=>{const{getGlobalContainer:n}=await import("./concordium-modal-logo-DS-Kh-HG-CfCNeDhs.js").then(o=>o.m);return{getGlobalContainer:n}},__vite__mapDeps([0,1,2])),a=s();if(!a||!t){console.error("Container or modal element not found");return}const e=t,i=p("success");i.id="processing-modal",i.classList.add("modal-entering"),a.appendChild(i),requestAnimationFrame(()=>{e&&e.classList.add("modal-exiting"),requestAnimationFrame(()=>{i.classList.remove("modal-entering"),i.classList.add("modal-visible")})}),t=i,e&&setTimeout(()=>{e.parentNode&&e.parentNode.removeChild(e)},300);const{dispatchConcordiumEvent:r}=await c(async()=>{const{dispatchConcordiumEvent:n}=await import("./concordium-modal-logo-DS-Kh-HG-CfCNeDhs.js").then(o=>o.m);return{dispatchConcordiumEvent:n}},__vite__mapDeps([0,1,2]));r({type:"success",source:"desktop",modalType:"processing",data:{state:"success",message:"Verification completed successfully"}})}export{p as createProcessingModal,g as hideProcessingModal,V as showProcessingModal,h as showSuccessState};
